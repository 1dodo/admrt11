...
const Home = () => {
  return (
    <div class="home-con h-full">
      <div class="container p-6 items-center max-w-screen-2xl px-8 mx-auto xl:px-5">
        <div class="flex flex-wrap items-center my-10 md:my-20 sm:-mx-3">
          <div class="w-full md:w-3/5 md:px-3">
            <div class="w-full pb-6   sm:pr-5 lg:pr-0 md:pb-0">
              ...
              <div>
                <h1 class="mt-3 font-light">Get Started now?<a class="text-blue-500 font-medium underline py-1 mx-2 cursor-pointer">Sign up now</a></h1>
              </div>
