    ...
    <div>
        ...
        <div class=" mt-32 mb-4 max-w-full mx-auto max-w-screen-2xl max-auto place-content-center justify-center justify-items-center grid md:grid-cols-2 lg:grid-cols-4 gap-x-20 gap-y-20">
          <div class=" number ease-in duration-700 cursor-pointer hover:shadow-2xl rounded-xl overflow-hidden max-w-xs order-first lg:order-none">
            <div class=" py-5 px-6 sm:px-8">
              ...
              <p class="text-gray-500 leading-relaxed">Use our search engine to find the best platform for your targeted audience to post your ad. Filter ad spaces based off budget and location</p>
            </div>
          </div>
          <div class="number ease-in duration-700 cursor-pointer hover:shadow-2xl rounded-xl overflow-hidden max-w-xs order-3 md:row-start-1 md:col-start-2 lg:order-none">
            <div class=" py-5 px-6 sm:px-8">
              ...
              <p class="text-gray-500 leading-relaxed">Send a message describing your ad and what you are looking for out of the ad space</p>
            </div>
          </div>
          <div class="number ease-in duration-700 cursor-pointer hover:shadow-2xl rounded-xl overflow-hidden max-w-xs order-5 lg:order-none">
            <div class=" py-5 px-6 sm:px-8">
              ...
              <p class="text-gray-500 leading-relaxed">Disclose ad space details and requirements such as content, posting date, availability, and pricing.</p>
            </div>
          </div>
          <div class="number ease-in duration-700 cursor-pointer hover:shadow-2xl rounded-xl overflow-hidden max-w-xs order-5 lg:order-none ">
            <div class=" py-5 px-6 sm:px-8">
              ...
              <p class="text-gray-500 leading-relaxed">See your content on their ad space. Submit a review and share your experience.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="bg-sky-100 ">
        <div class="md:flex max-w-6xl mx-auto p-24   mb-10 px-8  xl:px-5">
          <div class="w-full md:w-1/2 ml-8 items-center ">
            <div class="">
              <h1 class="font-bold text-4xl leading-10">Sell your <span class="text-blue-600">ad space</span></h1>
              <p class="font-normal text-sm leading-6 mt-4">Sell your ads in 3 simple steps.</p>
            </div>
            <div class="flex font-normal mt-4 text-lg leading-8">
              <img src={check} alt="" />
            ...
            <div class="flex mt-4 font-bold text-base leading-7">
          ...
          <div class="w-full md:w-1/2 px-8 xl:px-5">
            <div>
              <section class="duration-700 container rounded-lg">
                <div class="card rounded-lg bg-white hover:bg-blue-600 hover:text-white p-4 px-8 mt-6 shadow-lg">
                  <div class="content hover:bg-blue-600">
                    <h1 class="font-extrabold text-sm leading-7">Sign up as an space host.</h1>
              ...
              <section class="container rounded-lg">
                <div class="card rounded-lg bg-white hover:bg-blue-600 hover:text-white p-4 px-8 mt-6 shadow-lg">
                  <div class="content hover:bg-blue-600">
                    <h1 class="font-extrabold text-sm leading-7">Setup your account and get verified.</h1>
                    <div class="hover_content hover:bg-blue-600 flex">
                      <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                      <div class=" items-center relative">
                        <img class="logo img-fluid  w-96" src={bg} alt="mparticle" />
              ...
              <section class="container rounded-lg">
                <div class="card rounded-lg bg-white hover:bg-blue-600 hover:text-white p-4 px-8 mt-6 shadow-lg">
                  <div class="content hover:bg-blue-600">
                    <h1 class="font-extrabold text-sm leading-7">Get advertisers to contact you.</h1>
                    <div class="hover_content hover:bg-blue-600 flex">
                      <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                      <div class=" items-center relative">
                        <img class="logo img-fluid  w-96" src={bg} alt="mparticle" />
      ...
      <div class="md:flex items-center justify-end max-w-screen-2xl px-8 mx-auto xl:px-5">
        ...
        <div class=" ml-8 items-center ">
          <div class="">
            <h1 class="font-bold text-4xl leading-10">Why use AdMrt?</h1>
          </div>
          <div class="flex font-normal mt-4 text-lg leading-8">
            <img src={check} alt="" />
